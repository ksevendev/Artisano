...
class RouteListGroupCommand extends Command
{
    protected $signature = 'routes:listgroup';
    protected $description = 'Agrupa rotas';
    ...
    protected function executeCommand(SymfonyStyle $io)
    {
        ...
        $io->title("Executando RouteListGroupCommand");
        $io->table(['Item','Status'], [
            ['Database','OK'],
            ['Cache','Limpo'],
            ['Env',config('app.env')],
        ]);
        \$io->success("Rotas agrupadas")
    }
}