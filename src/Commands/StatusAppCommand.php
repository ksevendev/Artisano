...
class StatusAppCommand extends Command
{
    protected $signature = 'status:app';
    protected $description = 'Status completo';
    ...
    protected function executeCommand(SymfonyStyle $io)
    {
        ...
        $io->title("Executando StatusAppCommand");
        $io->table(['Item','Status'], [
            ['Database','OK'],
            ['Cache','Limpo'],
            ['Env',config('app.env')],
        ]);
        \$io->success("Status exibido")
    }
}