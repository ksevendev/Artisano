...
class DbMigrateRefreshCommand extends Command
{
    protected $signature = 'db:migrate:refresh';
    protected $description = 'Refresh DB';
    ...
    protected function executeCommand(SymfonyStyle $io)
    {
        ...
        $io->title("Executando DbMigrateRefreshCommand");
        $io->table(['Item','Status'], [
            ['Database','OK'],
            ['Cache','Limpo'],
            ['Env',config('app.env')],
        ]);
        \$io->success("Migrations refresh")
    }
}